<?php
class Tgen_DnD_35_DMG_Scroll_Arcane extends Tgen_DnD_35_DMG_Scroll {
    ...
    public function generateMinor() {
        ...
        for ($i = 1; $i <= $dieRoll; $i++) {
            ...
            if ($d100 > 95) { // 3rd Level spells
                $spells = new Tgen_DnD_35_DMG_Scroll_Arcane_Lv3($this->_hoard);
            } elseif ($d100 > 50) { // 2nd Level spells
                $spells = new Tgen_DnD_35_DMG_Scroll_Arcane_Lv2($this->_hoard);
            } elseif ($d100 > 5) { // 1st Level spells
                $spells = new Tgen_DnD_35_DMG_Scroll_Arcane_Lv1($this->_hoard);
            } else { // 0 Level spells
                $spells = new Tgen_DnD_35_DMG_Scroll_Arcane_Lv0($this->_hoard);
            }
    ...
    public function generateMedium() {
        ...
        for ($i = 1; $i <= $dieRoll; $i++) {
            ...
            if ($d100 > 95) { // 5th Level spells
                $spells = new Tgen_DnD_35_DMG_Scroll_Arcane_Lv5($this->_hoard);
            } elseif ($d100 > 65) { // 4th Level spells
                $spells = new Tgen_DnD_35_DMG_Scroll_Arcane_Lv4($this->_hoard);
    ...
    public function generateMajor() {
        ...
        for ($i = 1; $i <= $dieRoll; $i++) {
            ...
            if ($d100 > 95) { // 9th Level spells
                $spells = new Tgen_DnD_35_DMG_Scroll_Arcane_Lv9($this->_hoard);
            } elseif ($d100 > 85) { // 8th Level spells
                $spells = new Tgen_DnD_35_DMG_Scroll_Arcane_Lv8($this->_hoard);
            } elseif ($d100 > 70) { // 7th Level spells
                $spells = new Tgen_DnD_35_DMG_Scroll_Arcane_Lv7($this->_hoard);
            } elseif ($d100 > 50) { // 6th Level spells
                $spells = new Tgen_DnD_35_DMG_Scroll_Arcane_Lv6($this->_hoard);
