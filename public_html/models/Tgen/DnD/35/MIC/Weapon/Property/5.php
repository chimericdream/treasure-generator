<?php
class Tgen_DnD_35_MIC_Weapon_Property_5 extends Tgen_DnD_35_MIC_Weapon_Property {
    ...
    protected function _generateMelee() {
        ...
        if ($die > 80) {
            ...
            $prop3 = new Tgen_DnD_35_MIC_Weapon_Property_3($this->_hoard, $this->_baseWeapon);
            $prop2 = new Tgen_DnD_35_MIC_Weapon_Property_2($this->_hoard, $this->_baseWeapon);
            $property = $prop3->generate() . ' and '
                      . $prop2->generate();
            unset($prop3, $prop2);
        } elseif ($die > 20) {
            $prop4 = new Tgen_DnD_35_MIC_Weapon_Property_4($this->_hoard, $this->_baseWeapon);
            $prop1 = new Tgen_DnD_35_MIC_Weapon_Property_1($this->_hoard, $this->_baseWeapon);
...
} // end Tgen_DnD_35_MIC_Weapon_Property_5