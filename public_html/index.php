        ...
        case 'DnD':
            ...
            switch ($edition) {
                ...
                case '35_DMG':
                    ...
                    break;
                case '35_MIC':
                    $cr = $_POST['DnD_35_MIC_CR'];
                    $class .= $edition . '_CR' . $cr;
                    $options = array(
                        'multiplier'  => (int)  $_POST['DnD_35_MIC_Mult'],
                        'extSize'     => false,
//                        'extSize'     => (bool) $_POST['DnD_35_MIC_ExtSize'],
                        'cursed'      => (bool) $_POST['DnD_35_MIC_Cursed'],
                        'trade'       => (bool) $_POST['DnD_35_MIC_TradeGoods'],
                        'drac'        => false,
//                        'drac'        => (bool) $_POST['DnD_35_MIC_DracGoods'],
                        'ruleset'     => 'DnD',
                        'DnD_edition' => '35_MIC',
                        'cr'          => $cr,
                    );
