...
<form action="index.php" method="post" id="tgenform" class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <p>
                    ...
                    would like to generate treasure for.
                </p>
                <p>
                    <small>
        ...
        <div class="control-group DnD35">
            ...
            <div class="controls">
                <select name="mode35" id="mode35">
                    <option value="DMG"{% if tgenoptions.mode35 == "DMG" %} selected="selected"{% endif %}>DMG</option>
                    <option value="MIC"{% if tgenoptions.mode35 == "MIC" %} selected="selected"{% endif %}>MIC</option>
                </select>
                <p>
                    *Please select the tables to be used for rolling the treasure.
                </p>
                <p>
                    <small>
    ...
    <fieldset class="DnD35">
        ...
        <div class="control-group">
            <label class="control-label" for="ed3CR">Challenge Rating</label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label" for="ed3Mult">Treasure Multiplier</label>
            <div class="controls">
                <input type="text" name="ed3Mult" id="ed3Mult" value="{% if tgenoptions.multiplier %}{{ tgenoptions.multiplier }}{% else %}1{% endif %}" size="5" />
                <p>*1 = Standard, 2 = Double, etc up to 100... if you want to get ridiculous.</p>
            </div>
        </div>

        <div class="control-group">
            <label class="control-label" for="ed3ExtSize">Use Extended Sizes</label>
            <div class="controls">
                <input class="checkbox" type="checkbox" value="true" id="ed3ExtSize" name="ed3ExtSize" {% if tgenoptions.ed3ExtSize %}checked="checked" {% endif %}/>
                <p>
        ...
        <div class="control-group">
            <label class="control-label" for="ed3Cursed">Include Cursed items</label>
            <div class="controls">
                <input class="checkbox" type="checkbox" value="true" id="ed3Cursed" name="ed3Cursed" {% if tgenoptions.cursed %}checked="checked" {% endif %}/>
                <p>*This adds a 5% chance that any particular magic item in the hoard will be cursed.</p>
            </div>
        </div>

        <div class="control-group">
            <label class="control-label" for="ed3TradeGoods">Include Trade Goods</label>
            <div class="controls">
                <input class="checkbox" type="checkbox" value="true" id="ed3TradeGoods" name="ed3TradeGoods" {% if tgenoptions.trade %}checked="checked" {% endif %}/>
                <p>*Include trade goods generated using the tables in the Draconomicon.</p>
            </div>
        </div>

        <div class="control-group">
            <label class="control-label" for="ed3DracGoods">Include Goods from the Draconomicon</label>
            <div class="controls">
                <input class="checkbox" type="checkbox" value="true" id="ed3DracGoods" name="ed3DracGoods" {% if tgenoptions.drac %}checked="checked" {% endif %}/>
                <p>*DMG Only</p>
            </div>
        </div>
    </fieldset>
    ...
    <div class="control-group">
        <div class="controls">
            <button class="btn btn-inverse" type="submit">Generate Treasure</button>
        </div>
    </div>
</form>
